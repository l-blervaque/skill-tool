...
- **Skill Light** = frequent commands inline + lazy reference → great for *tiny, frequent* actions,
...
Skill Light to my tools."*

## Contents

- [`SETUP.md`](./SETUP.md) — the spec.
- [`tools/_TEMPLATE.md`](./tools/_TEMPLATE.md) — blank Skill Light file.
